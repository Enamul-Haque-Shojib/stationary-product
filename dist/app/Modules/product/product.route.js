...
router.patch("/:productId", product_controller_1.ProductController.updateOneProduct);
router.delete("/:productId", product_controller_1.ProductController.deleteOneProduct);
